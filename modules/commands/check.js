...
const path = __dirname + '/../../systemdata/data/messageCounts/';
...
this.run = async function({ api, event, args, Users, Threads }) {
...
this.handleReaction = function({ event, Users, Threads, api, handleReaction: _, Currencies }) {
  const fs = require('fs')
